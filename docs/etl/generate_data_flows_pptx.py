...
def build_presentation():
    ...
    add_body_text(slide, [
        ...
        "Daily budget:     100 descriptions/day (via --limit 100 in the daily load sequence)",
        ...
        "Integrated:       Step 2 of the daily load sequence (after opportunity load, before awards)",
        "",
