...
public class ReadOnlyRepository<T> : IReadOnlyRepository<T> where T : class
{
    ...
    public ReadOnlyRepository(FedProspectorDbContext context)
    {
        Context = context;
        DbSet = context.Set<T>();
    }
        ...
        Expression<Func<T, bool>>? filter = null)
    {
        ...
        // Apply ordering — use SortBy property if specified, otherwise
        // fall back to the entity's primary key descending
