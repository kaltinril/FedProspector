...
| 65 | USASpending Bulk Loader Improvements | COMPLETE | [65-USASPENDING-BULK-LOADER-IMPROVEMENTS.md](phases/completed/65-USASPENDING-BULK-LOADER-IMPROVEMENTS.md) |
| 65B | Bulk Loader Speed Optimizations | COMPLETE | [65B-BULK-LOADER-SPEED-OPTIMIZATIONS.md](phases/completed/65B-BULK-LOADER-SPEED-OPTIMIZATIONS.md) |
| 66 | MySQL Performance Tuning | COMPLETE | [66-MYSQL-PERFORMANCE-TUNING.md](phases/completed/66-MYSQL-PERFORMANCE-TUNING.md) |
...
| 104B | Batch pWin & Lazy-Load Grid Scores | COMPLETE | [104B-BATCH-PWIN-LAZY-LOAD.md](phases/completed/104B-BATCH-PWIN-LAZY-LOAD.md) |
...
| 133 | Linked Entity Aggregation Fixes + Sister Subsidiary + SBA Affiliation Size Roll-Up | COMPLETE | [133-LINKED-ENTITY-AGGREGATION-SISTER-SUBSIDIARY-SIZE-ROLLUP.md](phases/completed/133-LINKED-ENTITY-AGGREGATION-SISTER-SUBSIDIARY-SIZE-ROLLUP.md) |
...
| 136 | Recommended Opportunity Quality & Org Profile Editability | Complete — Units A/B/C/D/F/G deployed & validated on prod 2026-06-05 (endpoints live, migration applied); Unit E (NAICS-hierarchy relatedness) deferred (P3) | [136-RECOMMENDED-QUALITY-AND-ORG-PROFILE-EDITABILITY.md](phases/completed/136-RECOMMENDED-QUALITY-AND-ORG-PROFILE-EDITABILITY.md) |
...
| 310 | Dependency Updates & Package Maintenance | COMPLETE | [310-DEPENDENCY-UPDATES.md](phases/completed/310-DEPENDENCY-UPDATES.md) |
| 311 | ESLint 9 → 10 Upgrade | DEFERRED | [311-ESLINT-10-UPGRADE.md](phases/311-ESLINT-10-UPGRADE.md) |
